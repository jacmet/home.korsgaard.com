...
P1 pinout:
1: 5V        -> 5V input (disconnected on v2)
2: RTS       -> 5V input
3: Data GND  -> GND
4: N/C
5: TX        -> GPIO10, 2K2 pullup to 3V3
6: Power GND -> GND (disconnected on v2)
...
This is unfortunately not quite stable, so v2 drops the 5V input and cap,
and instead powered through the USB-C connector.
